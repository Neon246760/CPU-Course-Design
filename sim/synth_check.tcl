...
set output_dir [file join $root_dir build synth_check]
set part_name xc7a35tcsg324-1
if {$argc >= 1} {
  set part_name [lindex $argv 0]
}
file mkdir $output_dir
puts "INFO: synthesis target part is $part_name"
...
write_checkpoint -force [file join $output_dir soc_top_synth.dcp]
